...
public class CustomAnalyzer extends StopwordAnalyzerBase {
    ...
    public String[] getEnglishStopWordList(){
        String[] stopwords ={"about", "above","abroad","abst","accordance","according","accordingly","across","act","actually",
                "ad","added","adj","adopted","ae","af","affected","affecting","affects","after","afterwards",
                "ag","again","against","ago","ah","'ve","10","39","a","a's","able","ableabout", "ahead","ai",
                "ain't","aint","al","all","allow","allows","almost",
                ...
                "ive","'ll","j","je","jm","jo","join","jp","just","k","ke","keep","keeps","kept","keys","kg","kh","ki","kind","km","kn",
                ...
                "thousand","three","throug","through","throughout","thru","thus","til","till","tip","tis","'tis","'twas","tj","tk","tm","tn","to",
